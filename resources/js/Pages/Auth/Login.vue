...
import AuthenticationCardLogo from '@/Components/Card/AuthenticationCardLogo.vue';
                ...
                <form class="space-y-4" @submit.prevent="submit" >
                    ...
                    <div>
                        <div class="flex space-x-2 items-center justify-between">
                            ...
                            <Link v-if="canResetPassword" :href="route('password.request')" class="text-sm text-indigo-600 hover:text-indigo-5000">
                    ...
                    <div>
                        <PrimaryButton class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                            Sign In
                        </PrimaryButton>
                    </div>
                    ...
                    <div class="mx-auto flex items-center">
                        ...
                        <a href="auth/microsoft/login" class="flex w-full justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="20" viewBox="0 0 1033.746 220.695">
